...
HEROES = [
    {
        'name': result[0][0],
        'attack power': result[0][1],
        'maxHp': result[0][2],
        'imagePreview': player1Preview,
        'imagePreviewBig': player1BigGif,
        'selected': bool(result[0][3]),
        'attackE': result[0][4],
        'attackQ': result[0][5],
        'width': result[0][6],
        'height': result[0][7],
        'simpleAttack': result[0][8],
        'animations': {  # paths
    ...
    {
        'name': result[1][0],
        'attack power': result[1][1],
        'maxHp': result[1][2],
        'imagePreview': player2Paladin,
        'imagePreviewBig': player2PaladinBig,
        'selected': bool(result[1][3]),
        'attackE': result[1][4],
        'attackQ': result[1][5],
        'width': result[1][6],
        'height': result[1][7],
        'simpleAttack': result[1][8],
        'animations': {  # paths
